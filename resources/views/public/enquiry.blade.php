...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('public.enquiry') }}" method="post">
                    @if (Session::get('fail'))
                    ...
                    <div class="input-group mb-3">
                        <input type="mobile_bumber" class="form-control" name="mobile_bumber"
                            placeholder="Mobile Number" value="{{ old('mobile_bumber') }}">
                    </div>
                    <span class="text-danger">
                        @error('mobile_bumber')
                            {{ $message }}
                    ...
                    <div class="input-group mb-3">
                        <input type="email_id" class="form-control" name="email_id" placeholder="Email ID"
                            value="{{ old('email_id') }}">
                    </div>
                    <span class="text-danger">
                        @error('email_id')
