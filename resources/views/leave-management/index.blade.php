@extends('master')
@section('title', auth()->user()->first_name . ' ' . auth()->user()->last_name . ' | Preview Leave')
@section('content')
    @can('leave_show')
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-title float-right">
                                        <a href="{{ route('user.attendance.leave.management.create') }}">
                                            <input type="button" value="Apply New" class="btn btn-sm btn-success">
                                        </a>
                                    </div>
                                </div>
                                <!-- /.card-header -->
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                $('table').DataTable({
                    ...
                    ajax: '{{ route('user.attendance.leave.management.index') }}',
                    columns: [{
                            data: 'lm_id',
                            name: 'lm_id'
                        },
